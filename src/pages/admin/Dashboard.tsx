    ...
    <div className="px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-10">
        {[
          ...
          <div
            key={idx}
            className={`bg-gradient-to-br ${stat.gradient} text-white rounded-xl p-5 flex flex-col items-center justify-center transition-transform transform hover:scale-105 shadow-xl`}
          >
